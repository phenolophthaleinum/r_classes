...
align(index = "/path/to/index/chr19_mm10", readfile1 = "/path/to/fastq/file.fastq.gz", unique = T, nthreads = 8,
      output_file = paste("name","unique","BAM",sep=".")) # "nthreads" - its worth to change it
...
write.table(counts, file = "/path/to/save/counts.txt", sep = "\t", dec = ".") # save data frame with counts
```
